...
import com.advait.instagram_clone_improved.models.privatedetails;
...
public class EditProfile extends AppCompatActivity {
    ...
    TextView Email,Phonenumber,Gender,Birth,change_prof;
    ImageView submit;
    String useridd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        change_prof = (TextView) findViewById(R.id.tv_edit_profile_image);
